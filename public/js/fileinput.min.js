...
!function (e) {
    ...
    t = {
        ...
        cspBuffer: {
            CSP_ATTRIB: "data-csp-01928735", domElementsStyles: {}, stash: function (i) {
                ...
                n.find("[style]").each(function (i, r) {
                    var n = e(r), o = n.attr("style"), l = t.uniqId(), s = {};
        ...
        whenAll: function (i) {
            var a, r, n, o, l, s, d = [].slice, c = 1 === arguments.length && t.isArray(i) ? i : d.call(arguments),
                u = e.Deferred(), p = 0, f = c.length, g = f;
            for (n = o = l = Array(f), s = function (e, t, i) {
                return function () {
                    i !== c && p++, u.notifyWith(t[e] = this, i[e] = d.call(arguments)), --g || u[(p ? "reject" : "resolve") + "With"](t, i)
                }
            }, a = 0; f > a; a++) (r = c[a]) && e.isFunction(r.promise) ? r.promise().done(s(a, l, c)).fail(s(a, n, o)) : (u.notifyWith(this, r), --g);
        ...
        constructor: i, _cleanup: function () {
            ...
            var i = this, a = i.taskManager = {
                pool: {}, addPool: function (e) {
                    ...
                    r.id = i, r.cancelled = !1, r.cancelledDeferrer = e.Deferred(), r.tasks = {}, r.addTask = function (e, t) {
                        ...
                        var a, n, o, l = 0, s = !1, d = t.getObjectKeys(r.tasks).map(function (e) {
                            return r.tasks[e]
                        }), c = [], u = e.Deferred();
                        ...
                        }; d.length && l++ < i;) a = d.shift(), n(a), a.run();
                        return u
                    }, r.cancel = function () {
            ...
            i.uploadStartTime = t.now(), i.fileManager = {
                ...
                getUploadStats: function (e, a, r) {
                    var n, o = i.fileManager, l = e ? o.stats[e] && o.stats[e].started || t.now() : i.uploadStartTime,
                        s = (t.now() - l) / 1e3,
                        d = ["B/s", "KB/s", "MB/s", "GB/s", "TB/s", "PB/s", "EB/s", "ZB/s", "YB/s"],
                        c = Math.ceil(s ? a / s : 0), u = r - a, p = o.bpsLog.length ? i.bitrateUpdateDelay : 0;
                    return setTimeout(function () {
                        var e, t, i, a = 0, r = 0;
                        for (o.bpsLog.push(c), o.bpsLog.sort(function (e, t) {
                            return e - t
            ...
            if (a.enableResumableUpload) {
                ...
                i = a.resumableManager = {
                    init: function (e, t, n) {
                        i.logs = [], i.stack = [], i.error = "", i.id = e, i.file = t.file, i.fileName = t.name, i.fileIndex = n, i.completed = !1, i.lastProgress = 0, a.showPreview && (i.$thumb = o.getThumb(e) || null, i.$progress = i.$btnDelete = null, i.$thumb && i.$thumb.length && (i.$progress = i.$thumb.find(".file-thumb-progress"), i.$btnDelete = i.$thumb.find(".kv-file-remove"))), i.chunkSize = 1024 * r.chunkSize, i.chunkCount = i.getTotalChunks()
                    }, setAjaxError: function (e, t, o, l) {
                        e.responseJSON && e.responseJSON.error && (o = e.responseJSON.error.toString()), l || (i.error = o), r.showErrorLog && a._log(n.ajaxError, {
                            status: e.status,
                            error: o,
                            text: e.responseText || ""
                        })
                        ...
                        var t, n = i.id, l = i.$thumb, s = i.$progress, d = l && l.length,
                            c = {id: d ? l.attr("id") : "", index: o.getIndex(n), fileId: n};
                        i.completed = !0, i.lastProgress = 0, d && l.removeClass("file-uploading"), "success" === e ? (o.uploadedSize += i.file.size, a.showPreview && (a._setProgress(101, s), a._setThumbStatus(l, "Success"), a._initUploadSuccess(i.chunksProcessed[n].data, l)), o.removeFile(n), delete i.chunksProcessed[n], a._raise("fileuploaded", [c.id, c.index, c.fileId]), o.isProcessed() && a._setProgress(101)) : "cancel" !== e && (a.showPreview && (a._setThumbStatus(l, "Error"), a._setPreviewError(l, !0), a._setProgress(101, s, a.msgProgressError), a._setProgress(101, a.$progress, a.msgProgressError), a.cancelling = !0), a.$errorContainer.find('li[data-file-id="' + c.fileId + '"]').length || (t = a.msgResumableUploadRetriesExceeded.setTokens({
                            file: i.fileName,
                            max: r.maxRetries,
                            error: i.error
                        }), a._showFileError(t, c))), o.isProcessed() && i.reset()
                    }, check: function () {
                        var t = !0;
                        ...
                        e = setInterval(function () {
                            var l;
                            if (i.checkAborted(e), "new" === n && (a.lock(), n = "processing", l = r.shift(), o.initStats(l), o.stack[l] && (i.init(l, o.stack[l], o.getIndex(l)), i.processUpload())), !o.isPending(l) && i.completed && (n = "new"), o.isProcessed()) {
                                var s = a.$preview.find(".file-preview-initial");
                                s.length && (t.addCss(s, t.SORT_CSS), a._initSortable()), clearInterval(e), a._clearFileInput(), a.unlock(), setTimeout(function () {
                        ...
                        var n, l, s, d, c, u, p, f = i.id;
                        return r.testUrl ? (n = new FormData, l = o.stack[f], a._setUploadData(n, {
                            fileId: f,
                            fileName: l.fileName,
                            fileSize: l.size,
                            fileRelativePath: l.relativePath,
                            chunkSize: i.chunkSize,
                            chunkCount: i.chunkCount
                        }), s = function (e) {
                            p = a._getOutData(n, e), a._raise("filetestbeforesend", [f, o, i, p])
                        }, d = function (r, l, s) {
                            p = a._getOutData(n, s, r);
                            var d = a.uploadParamNames, c = d.chunksUploaded || "chunksUploaded", u = [f, o, i, p];
                            r[c] && t.isArray(r[c]) ? (i.chunksProcessed[f] || (i.chunksProcessed[f] = {}), e.each(r[c], function (e, t) {
                                i.logs[t] = !0, i.chunksProcessed[f][t] = !0
                            }), i.chunksProcessed[f].data = r, a._raise("filetestsuccess", u)) : a._raise("filetesterror", u), i.uploadResumable()
                        }, c = function (e, t, r) {
                            p = a._getOutData(n, e), a._raise("filetestajaxerror", [f, o, i, p]), i.setAjaxError(e, t, r, !0), i.uploadResumable()
                        }, u = function () {
                            a._raise("filetestcomplete", [f, o, i, a._getOutData(n)])
                        }, void a._ajaxSubmit(s, d, u, c, n, f, i.fileIndex, r.testUrl)) : void i.uploadResumable()
                    ...
                    }, sendAjax: function (e, l, s) {
                        var d, c = i.chunkSize, u = i.id, p = i.file, f = i.$thumb, g = t.logMessages, m = i.$btnDelete,
                            h = function (e, t) {
                                t && (e = e.setTokens(t)), e = "Error processing resumable ajax request. " + e, a._log(e), s.reject(e)
                            };
                        if (!i.chunksProcessed[u] || !i.chunksProcessed[u][e]) {
                            if (l > r.maxRetries) return h(g.resumableMaxRetriesReached, {n: r.maxRetries}), void i.setProcessed("error");
                            var v, w, b, _, C, y,
                                x = p.slice ? "slice" : p.mozSlice ? "mozSlice" : p.webkitSlice ? "webkitSlice" : "slice",
                                T = p[x](c * e, c * (e + 1));
            ...
            i = '{preview}\n<div class="kv-upload-progress kv-hidden"></div><div class="clearfix"></div>\n<div class="input-group {class}">\n  {caption}\n<div class="input-group-btn input-group-append">\n      {remove}\n      {cancel}\n      {pause}\n      {upload}\n      {browse}\n    </div>\n</div>', a = '{preview}\n<div class="kv-upload-progress kv-hidden"></div>\n<div class="clearfix"></div>\n{remove}\n{cancel}\n{upload}\n{browse}\n', r = '<div class="file-preview {class}">\n  {close}  <div class="{dropClass} clearfix">\n    <div class="file-preview-thumbnails clearfix">\n    </div>\n    <div class="file-preview-status text-center text-success"></div>\n    <div class="kv-fileinput-error"></div>\n  </div>\n</div>', o = t.closeButton("fileinput-remove"), n = '<i class="glyphicon glyphicon-file"></i>', l = '<div class="file-caption form-control {class}" tabindex="500">\n  <span class="file-caption-icon"></span>\n  <input class="file-caption-name">\n</div>', s = '<button type="{type}" tabindex="500" title="{title}" class="{css}" {status}>{icon} {label}</button>', d = '<a href="{href}" tabindex="500" title="{title}" class="{css}" {status}>{icon} {label}</a>', c = '<div tabindex="500" class="{css}" {status}>{icon} {label}</div>', Z = t.MODAL_ID + "Label", u = '<div id="' + t.MODAL_ID + '" class="file-zoom-dialog modal fade" tabindex="-1" aria-labelledby="' + Z + '"></div>', p = '<div class="modal-dialog modal-lg{rtl}" role="document">\n  <div class="modal-content">\n    <div class="modal-header">\n      <h5 class="modal-title" id="' + Z + '">{heading}</h5>\n      <span class="kv-zoom-title"></span>\n      <div class="kv-zoom-actions">{toggleheader}{fullscreen}{borderless}{close}</div>\n    </div>\n    <div class="modal-body">\n      <div class="floating-buttons"></div>\n      <div class="kv-zoom-body file-zoom-content {zoomFrameClass}"></div>\n{prev} {next}\n    </div>\n  </div>\n</div>\n', f = '<div class="progress">\n    <div class="{class}" role="progressbar" aria-valuenow="{percent}" aria-valuemin="0" aria-valuemax="100" style="width:{percent}%;">\n        {status}\n     </div>\n</div>{stats}', N = '<div class="text-info file-upload-stats"><span class="pending-time">{pendingTime}</span> <span class="upload-speed">{uploadSpeed}</span></div>', g = " <samp>({sizeText})</samp>",
                ...
                return "allowedPreviewTypes" === t ? void (void 0 === H.allowedPreviewTypes && (H.allowedPreviewTypes = i)) : void (H[t] = e.extend(!0, {}, i, H[t]))
            ...
            i.previewCache = {
                data: {}, init: function () {
                    ...
                    var r, n, o, l, s, d, c, u = t.INIT_FLAG + e, p = i.previewCache.data, f = p.config[e],
                        g = p.content[e], m = t.ifSet("previewAsData", f, i.initialPreviewAsData),
                        ...
                        v = function (e, a, r, n, o, l, s, d) {
                            var c = " file-preview-initial " + t.SORT_CSS + (s ? " " + s : ""),
                                u = i.previewInitId + "-" + l, p = f && f.fileId || u;
                    ...
                    var o, l = n.config[e], s = t.ifSet("caption", l), d = t.ifSet("width", l, "auto"),
                        ...
                        h = l.downloadUrl || m, v = l.filename || l.caption || "", w = !!h,
                        b = t.ifSet("showRemove", l, g), _ = t.ifSet("showDownload", l, t.ifSet("showDownload", f, w)),
                        C = t.ifSet("showZoom", l, t.ifSet("showZoom", f, !0)),
                        y = t.ifSet("showDrag", l, t.ifSet("showDrag", f, !0)), x = c === !1 && a;
            ...
            var i, a, r, n = this, o = n.$element, l = n.$form, s = n.$container;
            n._handler(o, "click", function (e) {
                o.hasClass("file-no-browse") && (o.data("zoneClicked") ? o.data("zoneClicked", !1) : e.preventDefault())
            }), n._handler(o, "change", e.proxy(n._change, n)), n.showBrowse && n._handler(n.$btnFile, "click", e.proxy(n._browse, n)), a = s.find(".file-caption-name"), r = function () {
                return !1
                ...
                n._listenFullScreen(screen.width === window.innerWidth && screen.height === window.innerHeight)
            }), i = "webkitfullscreenchange mozfullscreenchange fullscreenchange MSFullscreenChange", n._handler(e(document), i, function () {
                n._listenFullScreen(t.checkFullScreen())
            }), n._autoFitContent(), n._initClickable(), n._refreshPreview()
            ...
            var i, a, r, n, o = this, l = o.$preview, s = "." + t.SORT_CSS, d = e("body"), c = e("html"),
                u = o.reversePreviewOrder, p = window.Sortable;
            p && 0 !== l.find(s).length && (a = d.length ? d : c.length ? c : o.$container, r = function () {
                ...
                onEnd: n,
                onSort: function (i) {
                    var a, r = i.oldIndex, n = i.newIndex, l = 0, s = o.initialPreviewConfig.length,
                        d = s > 0 && n >= s, c = e(i.item);
            ...
            (t.autoOrientImageInitial || a) && t.getFrames(".file-preview-initial").each(function () {
                var r, n, o, l = e(this), s = t.initialPreviewConfig[i];
            ...
            var r, n, o, l, s, d, c, u, p, f, g = this, m = i.attr("id"), h = g._getZoom(m), v = g.$modal,
                w = v.find(".btn-fullscreen"), b = v.find(".btn-borderless"), _ = v.find(".btn-toggleheader");
            n = h.attr("data-template") || "generic", r = h.find(".kv-file-content"), o = r.length ? r.html() : "", p = i.data("caption") || "", f = i.data("size") || "", l = p + " " + f, v.find(".kv-zoom-title").attr("title", e("<div/>").html(l).text()).html(l), s = v.find(".kv-zoom-body"), v.removeClass("kv-single-content"), a ? (u = s.addClass("file-thumb-loading").clone().insertAfter(s), t.setHtml(s, o).hide(), u.fadeOut("fast", function () {
                ...
                var e, t = v.find(".modal-header"), i = v.find(".modal-body .floating-buttons"),
            ...
            var a, r, n, o, l = this, s = l.$modal.find(".kv-zoom-actions .btn-" + t), d = l.getFrames().toArray(),
                c = [], u = d.length;
            if (!s.attr("disabled")) {
                for (r = 0; u > r; r++) n = e(d[r]), n && n.length && n.find(".kv-file-zoom:visible").length && c.push(d[r]);
                for (u = c.length, r = 0; u > r; r++) if (e(c[r]).attr("id") === i) {
                    o = "prev" === t ? r - 1 : r + 1;
                    break
                }
            ...
            var e = this;
            e.uploadStartTime = t.now(), e.uploadCache = [], e.$btnUpload.removeAttr("disabled"), e._setProgress(0), e._hideProgress(), e._resetErrors(!1), e._initAjax(), e.fileManager.clearImages(), e._resetCanvas(), e.overwriteInitial && (e.initialPreview = [], e.initialPreviewConfig = [], e.initialPreviewThumbTags = [], e.previewCache.data = {
                content: [],
                config: [],
                tags: []
            })
            ...
            var i, a, r, n = this, o = n.showUploadedThumbs, l = !n.removeFromPreviewOnError,
                s = (o || l) && n.isDuplicateError;
            n.previewCache.count(!0) ? (i = n.previewCache.out(), s && (r = t.createElement("").insertAfter(n.$container), n.getFrames().each(function () {
                var t = e(this);
                (o && t.hasClass("file-preview-success") || l && t.hasClass("file-preview-error")) && r.append(t)
            })), n._setPreviewContent(i.content), n._setInitThumbAttr(), a = n.initialCaption ? n.initialCaption : i.caption, n._setCaption(a), s && (r.contents().appendTo(n.$preview), r.remove())) : (n._clearPreview(), n._initCaption()), n.showPreview && (n._initZoom(), n._initSortable()), n.isDuplicateError = !1
            ...
            var a = this, r = a.fileManager, n = function (e) {
                var n = 0, o = e.total, l = e.loaded || e.position, s = r.getUploadStats(i, l, o);
                e.lengthComputable && !a.enableResumableUpload && (n = t.round(l / o * 100)), i ? a._setFileUploadStats(i, n, s) : a._setProgress(n, null, null, a._getStats(s)), a._raise("fileajaxprogress", [s])
            };
            ...
            var n, o, l, s, d, c, u, p, f, g, m, h, v, w = this, b = w.fileManager, _ = b.count(), C = new FormData,
                y = w._getThumbId(a), x = _ > 0 || !e.isEmptyObject(w.uploadExtraData),
                T = w.ajaxOperations.uploadThumb, P = b.getFile(a), F = {id: y, index: i, fileId: a},
                k = w.fileManager.getFileName(a, !0);
            w.enableResumableUpload || (w.showPreview && (o = w.fileManager.getThumb(a), u = o.find(".file-thumb-progress"), s = o.find(".kv-file-upload"), d = o.find(".kv-file-remove"), u.show()), 0 === _ || !x || w.showPreview && s && s.hasClass("disabled") || w._abort(F) || (v = function () {
                ...
                n = w._getOutData(C, p, l), e.extend(!0, F, n), setTimeout(function () {
                    t.isEmpty(l) || t.isEmpty(l.error) ? (w.showPreview && (w._setThumbStatus(o, "Success"), s.hide(), w._initUploadSuccess(l, o, r), w._setProgress(101, u)), w._raise("fileuploaded", [n, g, i, w._getThumbFileId(o)]), r ? v() : w.fileManager.remove(o)) : (c = !0, f = w._parseError(T, p, w.msgUploadError, w.fileManager.getFileName(a)), w._showFileError(f, F), w._setPreviewError(o, !0), w.retryErrorUploads || s.hide(), r && v(), w._setProgress(101, w._getFrame(g).find(".file-thumb-progress"), w.msgUploadError))
                }, w.processDelay)
            }, m = function () {
                ...
                f = w._parseError(T, t, n, w.fileManager.getFileName(a)), c = !0, setTimeout(function () {
                    var i;
                    r && v(), w.fileManager.setProgress(a, 100), w._setPreviewError(o, !0), w.retryErrorUploads || s.hide(), e.extend(!0, F, w._getOutData(C, t)), w._setProgress(101, w.$progress, w.msgAjaxProgressError.replace("{operation}", T)), i = w.showPreview && o ? o.find(".file-thumb-progress") : "", w._setProgress(101, i, w.msgUploadError), w._showFileError(f, F)
                }, w.processDelay)
            }, w._setFileData(C, P.file, k, a), w._setUploadData(C, {fileId: a}), w._ajaxSubmit(p, g, m, h, C, a, i)))
            ...
            if (0 !== c && p && !s._abort(u)) {
                l = function () {
                    ...
                    o = s._parseError(g, t, a), s._showFileError(o, r, "filebatchuploaderror"), s.uploadFileCount = c - 1, s.showPreview && (s._getThumbs().each(function () {
                        var t = e(this);
                        t.removeClass("file-uploading"), s._getThumbFile(t) && s._setPreviewError(t)
                ...
                e.each(s.fileManager.stack, function (e, i) {
                    t.isEmpty(i.file) || s._setFileData(f, i.file, i.nameFmt || "untitled_" + m, e), m++
            ...
            var e = this;
            setTimeout(function () {
                var t, i, a, r = e.previewCache.count(!0), n = e.fileManager.count(),
            ...
            i.showPreview && (i._initZoomButton(), i.getFrames(" .kv-file-remove").each(function () {
                var a, r, n = e(this), o = n.closest(t.FRAMES), l = o.attr("id"), s = o.attr("data-fileindex");
                ...
                i._handler(a, "click", function () {
                    var e = a.closest(t.FRAMES), r = i._getThumbFile(e);
            ...
            return e.isNumeric(t) && e.isNumeric(o) ? ("function" == typeof l ? r = l(o) : 0 === o ? r = "0.00 B" : (i || (i = ["B", "KB", "MB", "GB", "TB", "PB", "EB", "ZB", "YB"]), a = Math.floor(Math.log(o) / Math.log(1024)), r = (o / Math.pow(1024, a)).toFixed(2) + " " + i[a]), n._getLayoutTemplate("size").replace("{sizeText}", r)) : ""
        }, _getFileType: function (e) {
            var t = this;
            return t.mimeTypeAliases[e] || e
        }, _generatePreviewTemplate: function (i, a, r, n, o, l, s, d, c, u, p, f, g, m) {
            var h, v, w, b = this, _ = b.slug(r), C = "", y = "",
                x = window.innerWidth || document.documentElement.clientWidth || document.body.clientWidth, T = _,
                P = _, F = "type-default", k = u || b._renderFileFooter(i, _, d, "auto", s), E = b.preferIconicPreview,
                S = b.preferIconicZoomPreview, I = E ? "other" : i;
            return v = 400 > x ? b.previewSettingsSmall[I] || b.defaults.previewSettingsSmall[I] : b.previewSettings[I] || b.defaults.previewSettings[I], v && e.each(v, function (e, t) {
                ...
                var m = d ? "zoom-" + o : o, h = b._getPreviewTemplate(a), v = (c || "") + " " + u;
                return b.frameClass && (v = b.frameClass + " " + v), d && (v = v.replace(" " + t.SORT_CSS, "")), h = b._parseFilePreviewIcon(h, r), "object" !== i || n || e.each(b.defaults.fileTypeSettings, function (e, t) {
                    "object" !== e && "other" !== e && t(r, n) && (F = "type-" + e)
            ...
            if (this.showPreview) {
                var o, l = this, s = t.getFileName(i), d = n.type, c = n.name, u = l._parseFileType(d, s),
                    p = l.$preview, f = i.size || 0, g = "image" === u ? a.target.result : r,
                    m = l.fileManager.getId(i), h = l._getThumbId(m);
                o = l._generatePreviewTemplate(u, g, s, d, h, m, !1, f), l._clearDefaultPreview(), l._addToPreview(p, o);
                var v = l._getFrame(h);
            ...
            var a, r, n, o, l, s = this, d = s.$element,
            ...
            if (a.showPreview) {
                var r = "indicator" + i, n = r + "Title", o = "file-preview-" + i.toLowerCase(),
                    l = e.find(".file-upload-indicator"), s = a.fileActionSettings;
            ...
            if (n.showPreview || o && o.length) {
                var l, s = n.fileManager, d = n.resumableManager, c = s.getThumb(i), u = 0, p = s.getTotalSize(),
                    f = e.extend(!0, {}, r);
                if (n.enableResumableUpload) {
                    var g, m = r.loaded, h = d.getUploadedSize(), v = d.file.size;
                    m += h, g = s.uploadedSize + m, a = t.round(100 * m / v), r.pendingBytes = v - h, n._setResumableProgress(a, r, c), l = Math.floor(100 * g / p), f.pendingBytes = p - g, n._setResumableProgress(l, f)
                } else s.setProgress(i, a), o = c && c.length ? c.find(".file-thumb-progress") : null, n._setProgress(a, o, null, n._getStats(r)), e.each(s.stats, function (e, t) {
                    u += t.loaded
                }), f.pendingBytes = p - u, l = t.round(u / p * 100), n._setProgress(l, null, null, n._getStats(f))
            }
            ...
            c && u || (s = "load.fileinputimageorient", f ? (i = a, a = null, i.css(d.previewSettings.image), l = e(document.createElement("div")).appendTo(n.find(".kv-file-content")), o = e(document.createElement("span")).insertBefore(i), i.css("visibility", "hidden").removeClass("file-zoom-detail").appendTo(l)) : p = !i.is(":visible"), i.off(s).on(s, function () {
                ...
                var e = i[0], s = a && a.length ? a[0] : null, c = e.offsetHeight, u = e.offsetWidth,
                    g = t.getRotation(r);
            ...
            var c, u, p, f = this, g = f.autoOrientImage;
            return f.canOrientImage ? (i.css("image-orientation", g ? "from-image" : "none"), void f._validateImage(r, n, o, l, s, d, c)) : (p = t.getZoomSelector(r, " img"), c = g ? f._getExifObj(d) : null, (u = c ? c["0th"][piexif.ImageIFD.Orientation] : null) ? (f.setImageOrientation(i, e(p), u, f._getFrame(r)), f._raise("fileimageoriented", {
                $img: i,
                file: a
            ...
            var o, l, s, d, c, u, p, f, g, m, h = this, v = e(a.img)[0], w = v.naturalWidth, b = v.naturalHeight, _ = 1,
                C = h.maxImageWidth || w, y = h.maxImageHeight || b, x = !(!w || !b), T = h.imageCanvas,
                P = h.imageCanvasContext, F = a.typ, k = a.pid, E = a.ind, S = a.thumb, I = a.exifObj;
            if (c = function (e, t, i) {
                ...
                index: E,
                fileId: i
            }, m = [i, k, E], (!f || !x || C >= w && y >= b) && (x && f && h._raise("fileimageresized", m), r.val++, r.val === n && h._raise("fileimagesresized"), !x)) return void c(h.msgImageResizeError, g, "fileimageresizeerror");
            F = F || h.resizeDefaultImageType, l = w > C, s = b > y, _ = "width" === h.resizePreference ? l ? C / w : s ? y / b : 1 : s ? y / b : l ? C / w : 1, h._resetCanvas(), w *= _, b *= _, T.width = w, T.height = b;
            try {
                P.drawImage(v, 0, 0, w, b), d = T.toDataURL(F, h.resizeQuality), I && (p = window.piexif.dump(I), d = window.piexif.insert(p, d)), o = t.dataURI2Blob(d), h.fileManager.setFile(i, o), h._raise("fileimageresized", m), r.val++, r.val === n && h._raise("fileimagesresized", [void 0, void 0]), o instanceof Blob || c(h.msgImageResizeError, g, "fileimageresizeerror")
            } catch (A) {
            ...
            var e = this, t = e.dropZoneEnabled ? " file-drop-zone" : "file-drop-disabled",
                ...
                a = e.showPreview ? e._getLayoutTemplate("preview").setTokens({
                    "class": e.previewClass, dropClass: t
            ...
            var o, l, s = this, d = s.fileActionSettings, c = d.showRemove, u = d.showDrag, p = d.showUpload,
                ...
                h = n ? d.indicatorError : d.indicatorNew, v = n ? d.indicatorErrorTitle : d.indicatorNewTitle,
            ...
            var f, g = l === !1 ? "" : ' data-url="' + l + '"', m = "", h = "",
                v = s === !1 ? "" : ' data-key="' + s + '"', w = "", b = "", _ = "",
                C = p._getLayoutTemplate("actions"), y = p.fileActionSettings,
            ...
            return a && (w = p._getLayoutTemplate("actionDelete").setTokens({
                ...
                dragIcon: y.dragIcon
            })), C.setTokens({"delete": w, upload: b, download: _, zoom: m, drag: h, other: x})
        }, _browse: function (e) {
            var t = this;
            ...
            if (!a.changeTriggered) {
                var r, n, o, l, s = a.$element, d = arguments.length > 1, c = a.isAjaxUpload,
                    u = d ? arguments[1] : s[0].files, p = a.fileManager.count(), f = t.isEmpty(s.attr("multiple")),
                    g = !c && f ? 1 : a.maxFileCount, m = a.maxTotalFileCount, h = m > 0 && m > g, v = f && p > 0,
                    w = function (t, i, r, n) {
            ...
            var a, r, n, o, l = e.name || "", s = e.type || "", d = (e.size || 0) / 1e3, c = i._parseFileType(s, l),
                ...
                g = i.disabledPreviewTypes, m = i.disabledPreviewMimeTypes, h = i.disabledPreviewExtensions || [],
                v = i.maxFilePreviewSize && parseFloat(i.maxFilePreviewSize) || 0,
                w = new RegExp("\\.(" + f.join("|") + ")$", "i"), b = new RegExp("\\.(" + h.join("|") + ")$", "i");
            ...
            var a, r = this, n = r.reader, o = r.$previewContainer, l = r.$previewStatus, s = r.msgLoading,
                d = r.msgProgress, c = r.previewInitId, u = i.length, p = r.fileTypeSettings, f = r.allowedFileTypes,
                g = f ? f.length : 0, m = r.allowedFileExtensions, h = t.isEmpty(m) ? "" : m.join(", "),
                v = function (t, n, o, l, s) {
                    var d, c = e.extend(!0, {}, r._getOutData(null, {}, {}, i), {id: o, index: l, fileId: s}),
                        p = {id: o, index: l, fileId: s, file: n, files: i};
                    r._previewDefault(n, !0), d = r._getFrame(o, !0), r.isAjaxUpload ? setTimeout(function () {
                        a(l + 1)
            ...
            r.fileManager.clearImages(), e.each(i, function (e, t) {
                ...
                r.lock(!0);
                var y, x, T, P, F, k, E, S, I, A, D, z, j = i[w], M = r._getFileId(j), U = c + "-" + M,
                    $ = (p.text, p.image), R = (p.html, r._getFileName(j, "")), O = (j && j.size || 0) / 1e3, B = "",
                    L = t.createObjectURL(j), N = 0, Z = "", H = !1, W = 0, q = function () {
                        var e = d.setTokens({index: w + 1, files: u, percent: 50, name: R});
                        setTimeout(function () {
                            l.html(e), r._updateFileDetails(u), a(w + 1)
                        }, r.processDelay), r._raise("fileloaded", [j, U, M, w, n]) && r.isAjaxUpload && C.add(j)
                    };
                if (j) {
                    if (S = C.getId(j), g > 0) for (x = 0; g > x; x++) k = f[x], E = r.msgFileTypes[k] || k, Z += 0 === x ? E : ", " + E;
                    if (R === !1) return void a(w + 1);
                    if (0 === R.length) return T = r.msgInvalidFileName.replace("{name}", t.htmlEncode(t.getFileName(j), "[unknown]")), void v(T, j, U, w, S);
                    if (t.isEmpty(m) || (B = new RegExp("\\.(" + m.join("|") + ")$", "i")), y = O.toFixed(2), r.isAjaxUpload && C.exists(S) || r._getFrame(U, !0).length) {
                        var V = {id: U, index: w, fileId: S, file: j, files: i};
                        return T = r.msgDuplicateFile.setTokens({
                            name: R,
                            size: y
                        }), void (r.isAjaxUpload ? (r.duplicateErrors.push(T), r.isDuplicateError = !0, r._raise("fileduplicateerror", [j, S, R, y, U, w]), a(w + 1), r._updateFileDetails(u)) : (r._showError(T, V), r.unlock(), u = 0, r._clearFileInput(), r.reset(), r._updateFileDetails(u)))
                    }
                    if (r.maxFileSize > 0 && O > r.maxFileSize) return T = r.msgSizeTooLarge.setTokens({
                        name: R,
                        size: y,
                        maxSize: r.maxFileSize
                    }), void v(T, j, U, w, S);
                    if (null !== r.minFileSize && O <= t.getNum(r.minFileSize)) return T = r.msgSizeTooSmall.setTokens({
                        name: R,
                        size: y,
                        minSize: r.minFileSize
                    }), void v(T, j, U, w, S);
                    if (!t.isEmpty(f) && t.isArray(f)) {
                        for (x = 0; x < f.length; x += 1) P = f[x], A = p[P], N += A && "function" == typeof A && A(j.type, t.getFileName(j)) ? 1 : 0;
                        if (0 === N) return T = r.msgInvalidFileType.setTokens({
                            name: R,
                            types: Z
                        }), void v(T, j, U, w, S)
                    }
                    if (0 === N && !t.isEmpty(m) && t.isArray(m) && !t.isEmpty(B) && (F = t.compare(R, B), N += t.isEmpty(F) ? 0 : F.length, 0 === N)) return T = r.msgInvalidFileExtension.setTokens({
                        name: R,
                        extensions: h
                    }), void v(T, j, U, w, S);
                    if (!r._canPreview(j)) return I = r.isAjaxUpload && r._raise("filebeforeload", [j, w, n]), r.isAjaxUpload && I && C.add(j), r.showPreview && I && (o.addClass("file-thumb-loading"), r._previewDefault(j), r._initFileActions()), void setTimeout(function () {
                        I && r._updateFileDetails(u), a(w + 1), r._raise("fileloaded", [j, U, M, w])
                    }, 10);
                    D = $(j.type, R), l.html(s.replace("{index}", w + 1).replace("{files}", u)), o.addClass("file-thumb-loading"), n.onerror = function (e) {
                        r._errorHandler(e, R)
                    }, n.onload = function (i) {
                        var a, s, d, c, u, f, g = [], m = function () {
                            var e = new FileReader;
                            e.onerror = function (e) {
                                r._errorHandler(e, R)
                            }, e.onload = function (e) {
                                return r.isAjaxUpload && !r._raise("filebeforeload", [j, w, n]) ? (H = !0, r._resetCaption(), n.abort(), l.html(""), o.removeClass("file-thumb-loading"), void r.enable()) : (r._previewFile(w, j, e, L, s), r._initFileActions(), void q())
                            }, e.readAsDataURL(j)
                        };
                        if (s = {name: R, type: j.type}, e.each(p, function (e, t) {
                            "object" !== e && "other" !== e && "function" == typeof t && t(j.type, R) && W++
                        }), 0 === W) {
                            for (d = new Uint8Array(i.target.result), x = 0; x < d.length; x++) c = d[x].toString(16), g.push(c);
                            if (a = g.join("").toLowerCase().substring(0, 8), f = t.getMimeType(a, "", ""), t.isEmpty(f) && (u = t.arrayBuffer2String(n.result), f = t.isSvg(u) ? "image/svg+xml" : t.getMimeType(a, u, j.type)), s = {
                                name: R,
                                type: f
                            }, D = $(f, "")) return void m(z)
                        }
                        return r.isAjaxUpload && !r._raise("filebeforeload", [j, w, n]) ? (H = !0, r._resetCaption(), n.abort(), l.html(""), o.removeClass("file-thumb-loading"), void r.enable()) : (r._previewFile(w, j, i, L, s), r._initFileActions(), void q())
                    }, n.onprogress = function (e) {
                        if (e.lengthComputable) {
                            var t = e.loaded / e.total * 100, i = Math.ceil(t);
                            T = d.setTokens({index: w + 1, files: u, percent: i, name: R}), setTimeout(function () {
                                H || l.html(T)
                            }, r.processDelay)
                        }
                    }, D ? n.readAsDataURL(j) : n.readAsArrayBuffer(j)
                }
            ...
            var t, i = this, a = i.resumableManager, r = i.ajaxRequests, n = r.length, o = a.getProgress(),
                l = i.fileActionSettings, s = i.taskManager, d = s.getPool(a.id);
            ...
            return i.showPreview && i._getThumbs().each(function () {
                ...
                a.removeClass("file-uploading"), n.attr("title") === l.indicatorLoadingTitle && (i._setThumbStatus(a, "Paused"), t = r.setTokens({
            ...
            var t, i = this, a = i.ajaxRequests, r = i.resumableManager, n = i.taskManager,
                o = r ? n.getPool(r.id) : void 0, l = a.length;
            if (i.enableResumableUpload && o ? (o.cancel().done(function () {
                i._setProgressCancelled()
            }), r.reset(), i._raise("fileuploadcancelled", [i.fileManager, r])) : i._raise("fileuploadcancelled", [i.fileManager]), i._initAjax(), l > 0) for (t = 0; l > t; t += 1) i.cancelling = !0, a[t].abort();
            return i._getThumbs().each(function () {
            ...
            return n.bpsLog = [], n.bps = 0, r.isAjaxUpload && !r.isDisabled && r._isFileSelectionValid(o) ? (r.lastProgress = 0, r._resetUpload(), 0 !== o || l ? (r.cancelling = !1, r._showProgress(), r.lock(), 0 === o && l ? (r._setProgress(2), void r._uploadExtraOnly()) : r.enableResumableUpload ? r.resume() : ((r.uploadAsync || r.enableResumableUpload) && (a = r._getOutData(null), r._raise("filebatchpreupload", [a]), r.fileBatchCompleted = !1, r.uploadCache = [], e.each(r.getFileStack(), function (e) {
            ...
            })) : (r._uploadBatch(), r.$element))) : void r._showFileError(r.msgUploadEmpty)) : void 0
        }, destroy: function () {
