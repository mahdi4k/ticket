...
@section('content')
    ...
    <div class="container">
        <div class="card mb-3">
            <div class="card-body justify-content-end align-self-end">
                @include('ticketit::shared.nav')
            </div>
        </div>
        @if(View::hasSection('ticketit_content'))
            <div class="card">
                <h5 class="card-header d-flex justify-content-between flex-row-reverse align-items-baseline flex-wrap">
