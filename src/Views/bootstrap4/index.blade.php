...
@section('page', trans('ticketit::lang.index-title',[],'fa'))
@section('page_title', trans('ticketit::lang.index-my-tickets',[],'fa'))


@section('ticketit_header')
{!! link_to_route($setting->grab('main_route').'.create', trans('ticketit::lang.btn-create-new-ticket',[],'fa'), null, ['class' => 'btn btn-primary']) !!}
@stop
{{--card-body pl-0 pr-0--}}
	...
	<script>
	    $('.table').DataTable({
	        ...
	        columns: [
	            ...
	            { data: 'FollowUp_area', name: 'FollowUp_area' },
