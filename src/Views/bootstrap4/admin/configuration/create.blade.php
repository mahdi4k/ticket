...
@section('ticketit_content')
    {!! CollectiveForm::open(['route' => $setting->grab('admin_route').'.configuration.store']) !!}
        ...
        <div class="form-group row">
            {!! CollectiveForm::label('slug', trans('ticketit::admin.config-edit-slug') . trans('ticketit::admin.colon'), ['class' => 'col-sm-3 text-center col-form-label']) !!}
            <div class="col-sm-9">
        ...
        <!-- Default Field -->
        <div class="form-group row">
            {!! CollectiveForm::label('default', trans('ticketit::admin.config-edit-default') . trans('ticketit::admin.colon'), ['class' => 'col-sm-3 text-center col-form-label']) !!}
            <div class="col-sm-9">
        ...
        <!-- Value Field -->
        <div class="form-group row">
            {!! CollectiveForm::label('value', trans('ticketit::admin.config-edit-value') . trans('ticketit::admin.colon'), ['class' => 'col-sm-3 text-center col-form-label']) !!}
            <div class="col-sm-9">
        ...
        <!-- Lang Field -->
        <div class="form-group row">
            {!! CollectiveForm::label('lang', trans('ticketit::admin.config-edit-language') . trans('ticketit::admin.colon'), ['class' => 'col-sm-3 text-center col-form-label']) !!}
            <div class="col-sm-9">
