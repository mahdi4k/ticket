...
@section('page', trans('ticketit::admin.config-edit-subtitle',[],'fa'))

@section('ticketit_header')
{!! link_to_route(
    $setting->grab('admin_route').'.configuration.index',
    trans('ticketit::admin.btn-back',[],'fa'), null,
...
@section('ticketit_content')
    {!! CollectiveForm::model($configuration, ['route' => [$setting->grab('admin_route').'.configuration.update', $configuration->id], 'method' => 'patch']) !!}
        <div class="card bg-light mb-3">
            <div class="card-body">
            <b>{{ trans('ticketit::admin.config-edit-tools',[],'fa') }}</b>
            <br>
            <a href="https://www.functions-online.com/unserialize.html" target="_blank">
                {{ trans('ticketit::admin.config-edit-unserialize',[],'fa') }}
            </a>
            <br>
            <a href="https://www.functions-online.com/serialize.html" target="_blank">
                {{ trans('ticketit::admin.config-edit-serialize',[],'fa') }}
            </a>
            </div>
        </div>

        @if(trans("ticketit::settings." . $configuration->slug) != ("ticketit::settings." . $configuration->slug) && trans("ticketit::settings." . $configuration->slug,[],'fa'))
            <div class="card border-info mb-3">
                <div class="card-body">{!! trans("ticketit::settings." . $configuration->slug,[],'fa') !!}</div>
            </div>
        @endif

        <!-- ID Field -->
        <div class="form-group row">
          {!! CollectiveForm::label('id', trans('ticketit::admin.config-edit-id',[],'fa') . trans('ticketit::admin.colon',[],'fa'), ['class' => 'col-sm-2 col-form-label']) !!}
          <div class="col-sm-9">
        ...
        <!-- Slug Field -->
        <div class="form-group row">
          {!! CollectiveForm::label('slug', trans('ticketit::admin.config-edit-slug',[],'fa') . trans('ticketit::admin.colon',[],'fa'), ['class' => 'col-sm-2 col-form-label']) !!}
          <div class="col-sm-9">
        ...
        <div class="form-group row">
          {!! CollectiveForm::label('default', trans('ticketit::admin.config-edit-default',[],'fa') . trans('ticketit::admin.colon',[],'fa'), ['class' => 'col-sm-2 col-form-label']) !!}
          <div class="col-sm-9">
        ...
        <!-- Value Field -->
        <div class="form-group row">
          {!! CollectiveForm::label('value', trans('ticketit::admin.config-edit-value',[],'fa') . trans('ticketit::admin.colon',[],'fa'), ['class' => 'col-sm-2 col-form-label']) !!}
          <div class="col-sm-9">
              @if(!$should_serialize)
        ...
        <!-- Serialize Field -->
        <div class="form-group row">
            {!! CollectiveForm::label('serialize', trans('ticketit::admin.config-edit-should-serialize',[],'fa') . trans('ticketit::admin.colon',[],'fa'), ['class' => 'col-sm-2 col-form-label']) !!}
            <div class="col-sm-9">
        ...
        <div id="serialize-password" class="form-group row">
            {!! CollectiveForm::label('password', trans('ticketit::admin.config-edit-reenter-password',[],'fa') . trans('ticketit::admin.colon',[],'fa'), ['class' => 'col-sm-2 col-form-label']) !!}
            <div class="col-sm-9">
        ...
        <!-- Lang Field -->
        <div class="form-group row">
          {!! CollectiveForm::label('lang', trans('ticketit::admin.config-edit-language',[],'fa') . trans('ticketit::admin.colon',[],'fa'), ['class' => 'col-sm-2 col-form-label']) !!}
          <div class="col-sm-9">
