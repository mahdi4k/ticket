...
@section('ticketit_content')
    ...
    @else
        ...
        <table class="table table-hover mb-0">
            <thead>
                <tr>
                    <th class="text-center">{{ trans('ticketit::admin.table-id') }}</th>
                    <th class="text-center">{{ trans('ticketit::admin.table-name') }}</th>
                    <th class="text-center">{{ trans('ticketit::admin.table-action') }}</th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        {!! link_to_route(
                            ...
                            {!! link_to_route(
                                                $setting->grab('admin_route').'.status.destroy', trans('ticketit::admin.btn-delete',[],'fa'), $status->id,
                                                [
