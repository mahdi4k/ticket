    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8 text-right">
                ...
                <form action="/ertebat/surveys/{{$questionnaire->id}}-{{Str::slug($questionnaire->title)}}" method="post">
                    @csrf
                    ...
                    @endforeach
                            ...
                            <input type="hidden" name="survey[name]" value="{{\Illuminate\Support\Facades\Auth::user()->name}}" class="form-control" id="name">

                            <input type="hidden" name="survey[email]" value="{{\Illuminate\Support\Facades\Auth::user()->email}}" class="form-control" id="email">
